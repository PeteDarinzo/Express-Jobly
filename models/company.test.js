...
describe("findAll", function () {
  ...
  test("filter minEmployees and name", async function () {
  ...
  test("filter maxEmployees and name", async function () {
    let companies = await Company.findAll({ maxEmployees: "2", name: "1" });
    expect(companies).toEqual([
      {
        handle: "c1",
        name: "C1",
  ...
  test("filter minEmployees, maxEmployees, and name", async function () {
    let companies = await Company.findAll({ minEmployees: "1", maxEmployees: "3", name: "2" });
    expect(companies).toEqual([
      {
        handle: "c2",
        name: "C2",
